...
```{r}
dfs <- slice_sample(df, n = 40000) 

mesh <- make_mesh(dfs, c("X", "Y"), cutoff = 6)
plot(mesh)
#str(df)
...
object.size(tot_nospace) / 10^9 # gb
...
# The randomized quantile residuals (returned by residuals()) and the MCMC based ones
