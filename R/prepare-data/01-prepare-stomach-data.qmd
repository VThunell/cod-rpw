...
fi <- read_csv(paste0(home, "/data/stomach/StomachContent_0820100197/File_information.csv"))
hi <- read_csv(paste0(home, "/data/stomach/StomachContent_0820100197/HaulInformation.csv"), 
               col_types = list(
...
pred <- read_csv(paste0(home, "/data/stomach/StomachContent_0820100197/PredatorInformation.csv")) # edited in text editor (not excel or equivalent) to remove three instances of erroneous '"' in column 'Notes' at row 7139,7144 and 7296.
#pred <- read_csv(paste0(home, "/data/stomach/StomachContent_0820100197/PredatorInformation.csv")) # Not edited
prey <- read_csv(paste0(home, "/data/stomach/StomachContent_0820100197/PreyInformation.csv"))
