...
# This is our looping index in for loops adding environmental variables below : TODO years pre 1993 and post 2022
...
```{r save}
# Save data
write_csv(dat_env2, paste0(home, "/data/clean/stom_env.csv"))
```
