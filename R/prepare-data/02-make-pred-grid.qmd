---
title: "Lammska cod prediction grid long env ts"
...
theNAs |> dplyr::select(lat,lon) |> distinct() # 526 latlon combos that are outside the hindcast extent
...
```{r save}
saveRDS(pred_grid_done, file = paste0(home, "/data/clean/pred_grid.rds"))
