...
1. Read in downloaded data from ICES stomach database
...
df <- dd |> 
  ...
  dplyr::select(fr_sad, fr_spr, fr_her, fr_oth, Year, Month, Day, pred_weight, pred_length,
                saduria, sprat, herring, lat, lon, ices_rect, X, Y)#, depth)
