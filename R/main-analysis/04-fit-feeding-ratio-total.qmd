...
Mod <- readRDS(Mod, file = paste0("fr-tot_Mod_ar1_b2024-04-10.rds"))
...
# estimate
plot_map_fc +
  geom_raster(data = pred_Mod_st$data, aes(X*1000, Y*1000, fill = exp(dec_mean_est))) +
  facet_wrap(~decade) +
  theme_sleek(base_size = 6) +
  geom_sf() +
...
plot_map_fc +
  geom_raster(data = pred_Mod_st$data, aes(X*1000, Y*1000, fill = exp(dec_mean_enrf))) +
  facet_wrap(~decade) +
  theme_sleek(base_size = 6) +
  geom_sf() +
  scale_fill_viridis(trans = "sqrt") +
...
plot_map_fc +
  ...
  # facet_wrap(~year) +
  geom_raster(data = pred_Mod_st$data, aes(X*1000, Y*1000, fill = dec_mean_erf)) +
  facet_wrap(~decade) +
  theme_sleek(base_size = 6) +
  geom_sf() +
  scale_fill_viridis() +
...
plot_map_fc +
  geom_raster(data = pred_Mod_st$data, aes(X*1000, Y*1000, fill = dec_mean_eps)) +
  facet_wrap(~decade) +
  theme_sleek(base_size = 6) +
  geom_sf() +
  scale_fill_viridis() +
