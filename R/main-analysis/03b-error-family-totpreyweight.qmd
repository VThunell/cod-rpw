...
We need to cut off the feeding rations to remove likely erroneous data. The fedding rations can however be high, fish can eat big prey. So where do we place the cutoff? And which of gamma and lognormal best represent the data?
