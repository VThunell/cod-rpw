...
# mesh_long <- make_mesh(df_long_env, c("X", "Y"), cutoff = 25)
# #plot(mesh_long)
# 
# # missing years
...
# )
# time - Sys.time()
# object.size(Mod_2denv_iid2)/1000^2 
# #saveRDS(Mod_2denv_iid2, file = paste0(home, "/R/main-analysis/fr-pg_Mod_2ds_env",Sys.Date(),".rds"))
# #Mod_2denv <- readRDS(file = paste0(home, "/R/main-analysis/fr-pg_Mod_2ds_env2024-10-02.rds"))
...
# time - Sys.time() # 
# time <- Sys.time()
# predict(Mod_2denv_iid2)
# time - Sys.time() # 

# no diff in size due to 25 instead of 15 cutoff
# gc()

mesh_long <- make_mesh(df_long_env, c("X", "Y"), cutoff = 15)
plot(mesh_long)
...
time - Sys.time()
#saveRDS(Mod_2denv_iid3, file = paste0(home, "/R/main-analysis/fr-pg_Mod_1ds_env",Sys.Date(),".rds"))
#readRDS(Mod_2denv_iid3, file = paste0(home, "/R/main-analysis/fr-pg_Mod_1ds_env",Sys.Date(),".rds"))
...
#saveRDS(Mod_2denv_iid1_nox, file = paste0(home, "/R/main-analysis/fr-pg_Mod_2ds_env_post1989",Sys.Date(),".rds"))
...
```{r Run and check model alternatives}
# df_long_env_samp <- df_long_env |>
...
#     prey_group_f +
#     # #s(pred_length_sc, year_sc, by = prey_group_f) +
#     # # Skippiung the 2d interaction here
#     # s(pred_length_sc, by = prey_group_f) +
#     # s(year_sc, by = prey_group_f) +
#     s(doy_sc, bs = "cc") +
#     depth_sc +
