...
dfß <- read_csv(paste0(home, "/data/clean/stomachs.csv")) |>
...
pred_grid$depth <- pred_grid$depth*-1 # To make depth from negative elevation in relation to sea surface??
...
## Add ICES areas
VT: changed dat_full to pred_grid
```{r ices areas}
...
pred_grid_63_92 <- pred_grid |> filter(year < 1993)
pred_grid_93_22 <- pred_grid |> filter(year > 1992)
